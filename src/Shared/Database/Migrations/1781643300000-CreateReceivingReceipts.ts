...
export class CreateReceivingReceipts1781643300000 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    `);
    await queryRunner.query(`CREATE UNIQUE INDEX "UQ_receipts_inbound_plan" ON "receipts" ("inbound_plan_id")`);
    await queryRunner.query(`CREATE INDEX "IDX_receipts_owner_warehouse" ON "receipts" ("owner_id", "warehouse_id")`);
    await queryRunner.query(
      `CREATE UNIQUE INDEX "UQ_receiving_sessions_plan_key" ON "receiving_sessions" ("inbound_plan_id", "session_key")`,
    );
    await queryRunner.query(`CREATE INDEX "IDX_receiving_sessions_receipt" ON "receiving_sessions" ("receipt_id")`);
    await queryRunner.query(`CREATE INDEX "IDX_receipt_lines_receipt" ON "receipt_lines" ("receipt_id")`);
    await queryRunner.query(`CREATE INDEX "IDX_receipt_lines_plan_line" ON "receipt_lines" ("inbound_plan_line_id")`);
    await queryRunner.query(
      `CREATE UNIQUE INDEX "UQ_receipt_lines_idempotency" ON "receipt_lines" ("receipt_id", "idempotency_key")`,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`DROP INDEX "public"."UQ_receipt_lines_idempotency"`);
    await queryRunner.query(`DROP INDEX "public"."IDX_receipt_lines_plan_line"`);
    await queryRunner.query(`DROP INDEX "public"."IDX_receipt_lines_receipt"`);
    await queryRunner.query(`DROP INDEX "public"."IDX_receiving_sessions_receipt"`);
    await queryRunner.query(`DROP INDEX "public"."UQ_receiving_sessions_plan_key"`);
    await queryRunner.query(`DROP INDEX "public"."IDX_receipts_owner_warehouse"`);
    await queryRunner.query(`DROP INDEX "public"."UQ_receipts_inbound_plan"`);
