...
@Index('UQ_integration_interface_message_id', ['MessageId'], { unique: true })
@Index('IDX_integration_interface_business_reference', ['BusinessReference', 'WarehouseContext', 'OwnerContext'])
@Index('IDX_integration_interface_batch', ['ImportBatchId'])
@Entity({ name: 'integration_interface_messages' })
export class InterfaceMessageOrmEntity {
  @PrimaryColumn({ name: 'id', type: 'char', length: 36 })
  public Id!: string;

  @Column({ name: 'import_batch_id', type: 'char', length: 36, nullable: true })
  public ImportBatchId!: string | null;

  @Column({ name: 'message_id', type: 'varchar', length: 120 })
  public MessageId!: string;

  @Column({ name: 'message_type', type: 'varchar', length: 100 })
  ...
  @Column({ name: 'message_status', type: 'varchar', length: 30 })
