...
@Module({
  ...
  providers: [
    ...
    },
    {
      ...
      ) => new UpdateWarehouseUseCase(warehouses, sites, ownership, audited, checker),
      inject: [
        WAREHOUSE_REPOSITORY,
        SITE_REPOSITORY,
        MASTER_DATA_OWNERSHIP_POLICY_SERVICE,
    ...
    },
    {
      ...
      useFactory: (
        ...
        audited: AuditedTransaction,
        checker: IPermissionChecker,
      ) => new UpdateLocationUseCase(locations, locationProfiles, warehouses, zones, ownership, audited, checker),
      inject: [
        LOCATION_REPOSITORY,
        LOCATION_PROFILE_REPOSITORY,
        WAREHOUSE_REPOSITORY,
    ...
    },
    {
      ...
      useFactory: (
        ...
        audited: AuditedTransaction,
        checker: IPermissionChecker,
      ) => new UpdateOwnerUseCase(owners, ownership, audited, checker),
      inject: [OWNER_REPOSITORY, MASTER_DATA_OWNERSHIP_POLICY_SERVICE, AuditedTransaction, PERMISSION_CHECKER],
    },
    {
    ...
    },
    {
      ...
      useFactory: (
        ...
        audited: AuditedTransaction,
        checker: IPermissionChecker,
      ) => new UpdateSkuUseCase(skus, owners, uoms, ownership, audited, checker),
      inject: [
        SKU_REPOSITORY,
        OWNER_REPOSITORY,
        UOM_REPOSITORY,
    ...
    },
    {
      ...
      useFactory: (
        ...
        audited: AuditedTransaction,
        checker: IPermissionChecker,
      ) => new UpdateItemCoverageUseCase(itemCoverages, skus, warehouses, owners, audited, checker),
      inject: [
        ITEM_COVERAGE_REPOSITORY,
        SKU_REPOSITORY,
        WAREHOUSE_REPOSITORY,
