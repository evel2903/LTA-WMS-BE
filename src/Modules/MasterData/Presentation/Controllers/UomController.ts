...
export class UomController {
  ...
  public async Create(@Body() request: CreateUomRequest, @CurrentAuditContext() context: AuditContext) {
    return await this.createUomUseCase.Execute(request, context);
  }
  ...
  public async Update(
    ...
    return await this.updateUomUseCase.Execute({ Id: id, ...request }, context);
  }
}
