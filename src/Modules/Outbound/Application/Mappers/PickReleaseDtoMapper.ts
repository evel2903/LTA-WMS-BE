...
export class PickReleaseDtoMapper {
  ...
  public static ToTaskDto(task: PickTaskEntity): PickTaskDto {
    return {
      ...
      ExceptionCaseId: task.ExceptionCaseId,
      ExceptionReasonCode: task.ExceptionReasonCode,
      ExceptionReasonNote: task.ExceptionReasonNote,
      ExceptionEvidenceJson: task.ExceptionEvidenceJson,
      ExceptionReportedAt: task.ExceptionReportedAt,
      ExceptionReportedBy: task.ExceptionReportedBy,
      ReplenishmentRequired: task.ReplenishmentRequired,
      ReplenishmentTaskId: task.ReplenishmentTaskId,
      SubstitutionStatus: task.SubstitutionStatus,
      SubstitutionSkuId: task.SubstitutionSkuId,
      SubstitutionSkuCode: task.SubstitutionSkuCode,
      SubstitutionUomId: task.SubstitutionUomId,
      SubstitutionUomCode: task.SubstitutionUomCode,
      SubstitutionQuantity: task.SubstitutionQuantity,
      SubstitutionApprovalRequestId: task.SubstitutionApprovalRequestId,
      SubstitutionPolicyJson: task.SubstitutionPolicyJson,
      SubstitutionRequestedAt: task.SubstitutionRequestedAt,
      SubstitutionRequestedBy: task.SubstitutionRequestedBy,
