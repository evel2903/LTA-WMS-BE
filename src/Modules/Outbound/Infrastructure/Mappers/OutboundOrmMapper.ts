...
export class OutboundOrmMapper {
  ...
  public static ToPickTaskDomain(entity: PickTaskOrmEntity): PickTaskEntity {
    return new PickTaskEntity({
      ...
      ExceptionType: entity.ExceptionType as PickTaskEntity['ExceptionType'],
      ExceptionCaseId: entity.ExceptionCaseId,
      ExceptionReasonCode: entity.ExceptionReasonCode,
      ExceptionReasonCodeId: entity.ExceptionReasonCodeId,
      ExceptionReasonNote: entity.ExceptionReasonNote,
      ExceptionEvidenceJson: entity.ExceptionEvidenceJson,
      ExceptionIdempotencyKey: entity.ExceptionIdempotencyKey,
      ExceptionPayloadFingerprint: entity.ExceptionPayloadFingerprint,
      ExceptionReportedAt: entity.ExceptionReportedAt ? new Date(entity.ExceptionReportedAt) : null,
      ExceptionReportedBy: entity.ExceptionReportedBy,
      ReplenishmentRequired: entity.ReplenishmentRequired,
      ReplenishmentTaskId: entity.ReplenishmentTaskId,
      SubstitutionStatus: entity.SubstitutionStatus as PickTaskEntity['SubstitutionStatus'],
      SubstitutionSkuId: entity.SubstitutionSkuId,
      SubstitutionSkuCode: entity.SubstitutionSkuCode,
      SubstitutionUomId: entity.SubstitutionUomId,
      SubstitutionUomCode: entity.SubstitutionUomCode,
      SubstitutionQuantity: entity.SubstitutionQuantity === null ? null : Number(entity.SubstitutionQuantity),
      SubstitutionApprovalRequestId: entity.SubstitutionApprovalRequestId,
      SubstitutionPolicyJson: entity.SubstitutionPolicyJson,
      SubstitutionIdempotencyKey: entity.SubstitutionIdempotencyKey,
      SubstitutionPayloadFingerprint: entity.SubstitutionPayloadFingerprint,
      SubstitutionRequestedAt: entity.SubstitutionRequestedAt ? new Date(entity.SubstitutionRequestedAt) : null,
      SubstitutionRequestedBy: entity.SubstitutionRequestedBy,
      CreatedAt: entity.CreatedAt,
    });
  }
