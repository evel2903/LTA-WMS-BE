...
export class ShippingStagingDtoMapper {
  public static ToDto(entity: ShipmentPackageStagingEntity): ShipmentPackageStagingDto {
    return {
      ...
      GateOutAt: date(entity.GateOutAt),
      GateOutBy: entity.GateOutBy,
      GoodsIssueTrigger: entity.GoodsIssueTrigger,
      GoodsIssueTriggerStatus: entity.GoodsIssueTriggerStatus,
      GoodsIssueTriggeredAt: date(entity.GoodsIssueTriggeredAt),
