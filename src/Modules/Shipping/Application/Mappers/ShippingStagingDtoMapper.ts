...
export class ShippingStagingDtoMapper {
  public static ToDto(entity: ShipmentPackageStagingEntity): ShipmentPackageStagingDto {
    return {
      ...
      GoodsIssueStatus: entity.GoodsIssueStatus,
      GoodsIssuePostedAt: date(entity.GoodsIssuePostedAt),
      GoodsIssuePostedBy: entity.GoodsIssuePostedBy,
      GoodsIssueInventoryTransactionId: entity.GoodsIssueInventoryTransactionId,
      GoodsIssueInventoryMovementId: entity.GoodsIssueInventoryMovementId,
      ...
      GoodsIssueOutboxMessageId: entity.GoodsIssueOutboxMessageId,
      ShipmentClosedOutboxMessageId: entity.ShipmentClosedOutboxMessageId,
      ShipmentClosedAt: date(entity.ShipmentClosedAt),
