...
export class ShippingStagingOrmMapper {
  public static ToDomain(entity: ShipmentPackageStagingOrmEntity): ShipmentPackageStagingEntity {
    return new ShipmentPackageStagingEntity({
      ...
      GoodsIssueIdempotencyKey: entity.GoodsIssueIdempotencyKey,
      GoodsIssuePayloadFingerprint: entity.GoodsIssuePayloadFingerprint,
      ...
      GoodsIssueStatus: entity.GoodsIssueStatus as never,
      GoodsIssuePostedAt: entity.GoodsIssuePostedAt,
      ...
      ShipmentClosedAt: entity.ShipmentClosedAt,
